...
def ddpg(env_fn, actor_critic=core.mlp_actor_critic, ac_kwargs=dict(), seed=0,
         ...
         act_noise=0.01, max_ep_len=1000, logger_kwargs=dict(), save_freq=1,
         time_horizon=50, discount_rate=0.06):
    """
    ...
    #env, test_env = env_fn(time_horizon, discount_rate), env_fn(time_horizon, disc)
